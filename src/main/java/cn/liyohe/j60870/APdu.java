...
import cn.liyohe.j60870.internal.ExtendedDataInputStream;
...
public class APdu {
    ...
    public static APdu decode(InputStream input,ConnectionSettings settings) throws IOException {

        ExtendedDataInputStream is = new ExtendedDataInputStream(input);
